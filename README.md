...
A powerful and intuitive web application. Powered by the Rest Country API, Metrics Map brings to life the fascinating world of population distribution in a visually appealing and easy-to-use interface.
...
- Uses a REST API
- Ability to display more details
...
Command : git clone git@github.com:abenaTenkorang/metrics_app.git
